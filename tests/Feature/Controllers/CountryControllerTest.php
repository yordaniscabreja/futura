...
class CountryControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_countries()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_country()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_country()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_country()
    {
        $country = Country::factory()->create();
