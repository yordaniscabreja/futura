    ...
    <div class="searchbar mt-0 mb-4">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                <a href="{{ route('bonds.create') }}" class="btn btn-primary">
    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.bonos.index_title')</h4>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    @endcan @can('delete', $bond)
                                    <form
                                        action="{{ route('bonds.destroy', $bond) }}"
                                        method="POST"
