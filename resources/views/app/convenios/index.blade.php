    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.convenios_universidades.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.convenios_universidades.inputs.title')
                            </th>
                            <th class="text-left">
                                @lang('crud.convenios_universidades.inputs.image')
                            </th>
                            <th class="text-left">
                                @lang('crud.convenios_universidades.inputs.about')
                            </th>
                            <th class="text-left">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $convenios->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
